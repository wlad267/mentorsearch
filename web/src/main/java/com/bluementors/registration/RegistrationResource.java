...
@RestController
@RequestMapping(value = "/api/registration", produces= MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
public class RegistrationResource {
    ...
    @GetMapping(value = "/confirmation/{requestUuid}", produces = MediaType.TEXT_PLAIN_VALUE)
    public ResponseEntity registrationConfirmation(@PathVariable("requestUuid") String uuid) {
        ...
        return ResponseEntity.ok(registrationService.confirmRegistration(UUID.fromString(uuid)));
    }
